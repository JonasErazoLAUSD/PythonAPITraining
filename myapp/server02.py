...
def dopostj():
    ...
    for rec_row in data:
        rec_data = {}
        rec_data["name"]= rec_row["name"]
        rec_data["addr"]= rec_row["addr"]
        rec_data["city"]= rec_row["city"]
        rec_data["pin"]= rec_row["pin"]
        reclist.append((rec_data)
